...
humandate: "Feb 4, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Sam Csik", "Kat Le", "Jamie Montgomery", "Amelia Meyer"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2022-02-04-ucsb-sql-online # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: 252410595887     # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
{% else %}
<p><a href="https://forms.gle/2XgDg1CRugtdUCgB6">Pre-workshop Survey</a></p>
